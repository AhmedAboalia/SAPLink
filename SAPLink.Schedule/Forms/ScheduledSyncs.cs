...
using static SAPLink.Core.Models.Schedule;
...
public partial class ScheduledSyncs : Form
{
    ...
    private static List<Core.Models.Schedule> Schedules;
    ...
    private static Core.Models.Schedule GetSchedule(int selectedIndex)
    {
