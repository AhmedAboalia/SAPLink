...
namespace SAPLink.Schedule.Forms
{
    partial class ScheduledSyncs
    {
        ...
        private void InitializeComponent()
        {
            ...
            tabControlInventory.Size = new Size(1208, 661);
            ...
            tabPageDaily.Controls.Add(guna2TabControl4);
            ...
            tabPageDaily.Size = new Size(1200, 613);
            ...
            comboBoxDocTypeSchedule.Items.AddRange(new object[] { "-None-", "--Departments", "--Vendors", "Items", "Goods Receipt Po (GRPO)", "--Goods Receipt (GR) - In", "--Goods Issue (GI) - In", "Sales Invoices", "Return Invoices", "--Customer Orders", "Stock Transfers", "--Inventory Posting", "--Goods Receipt (GR) - Out", "--Goods Issue (GI) - Out" });
