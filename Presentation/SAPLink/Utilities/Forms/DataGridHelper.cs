...
namespace SAPLink.Utilities.Forms
{
    ...
    {
        public static void BindInvoices(this Guna2DataGridView gridView, ref BindingList<Invoice>? bindingList, Invoice invoice)
        {
            if (bindingList == null)
            {
                bindingList = new BindingList<Invoice>();
        ...
        public static void BindInvoices(this TreeView treeView, ref BindingList<Invoice>? bindingList, Invoice invoice)
        {
            //if (bindingList == null)
            //{
