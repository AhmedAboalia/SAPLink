...
using SAPLink.Application.Prism.Handlers.OutboundData.PointOfSale;
using SAPLink.Application.Prism.Handlers.OutboundData.PointOfSale.CreditMemo;
using SAPLink.Application.Prism.Handlers.OutboundData.PointOfSale.DownPayment;
using SAPLink.Application.Prism.Handlers.OutboundData.PointOfSale.Invoice;
using SAPLink.Application.Prism.Handlers.OutboundData.PointOfSale.Orders;
using SAPLink.Application.Prism.Handlers.OutboundData.PointOfSale.Returns;
...
public partial class OutboundData : Form
{
    ...
    private readonly Application.Prism.Handlers.OutboundData.PointOfSale.Handler _handler;
        ...
        ItemsService itemsService, Clients client)
    {
        ...
        _handler = new Application.Prism.Handlers.OutboundData.PointOfSale.Handler(_client);
