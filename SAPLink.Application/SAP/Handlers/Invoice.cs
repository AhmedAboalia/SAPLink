...
partial class ServiceLayerHandler 
{
    ...
    public static string CreateReturnBody(PrismInvoice invoice, List<TaxCodes> taxCodes, string customerCode, string series, UpdateType updateType)
    {
    ...
    public static string CreateDownPaymentBody(PrismInvoice invoice, List<TaxCodes> taxCodes, string customerCode, string series)
    {
